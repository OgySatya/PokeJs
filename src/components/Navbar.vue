...
<template>
    <nav
        ...
        <div class="dropdown">
            <div tabindex="0" role="button" class="btn text-xl">
                Theme
            ...
            <ul tabindex="0" class="dropdown-content z-[1] p-2 shadow-2xl bg-base-300 rounded-box w-fit">
